...
const MemberIdPage = async ({
    ...
    return ( 
        <div className="bg-white dark:bg-[#313338] flex flex-col h-full">
            ...
            <ChatMessages member={currentMember} name={otherMember.profile.name} chatId={conversation.id} type="conversation" apiUrl="/api/direct-messages" paramKey='conversationId' socketUrl="/api/socket/direct-messages" socketQuery={{
